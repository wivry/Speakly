    ...
    (_class =
      RenderCanvas(
        (_class =
                  ...
                  (_ret =
                    ((_temp =
                      ((_this = _possibleConstructorReturn(
                        this,
                        (_ref =
                          AudioAnalyser.__proto__ ||
                          Object.getPrototypeOf(AudioAnalyser)).call.apply(
                          _ref,
                          [this].concat(args)
                        )
                      )),
                      _this)),
                    (_this.audioProgress = function () {
                      ...
                      var source =
                        _this.audioCtx.createMediaElementSource(audio);
                ...
                [
                  {
                    ...
                    value: function shouldComponentUpdate(nextProps) {
                      return AudioAnalyser.checkRender(
                        this.props,
                        nextProps,
                        AudioAnalyser.renderProps
                      );
                    },
                  },
                  {
                ...
                [
                  {
                    ...
                    value: function checkRender(props, nextProps, renderProps) {
                      var keys = [].concat(
                        _toConsumableArray(new Set(renderProps))
                      );
          ...
          (_class2.renderProps = ["status", "audioSrc"]),
          _temp2))
      ) || _class)
  ) || _class;
